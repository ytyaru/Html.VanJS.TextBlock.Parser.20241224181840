class BlockParser { // fence, text の二種類に大別する
    ...
    get textBlockPreprocess() {return this._preprocessor.text}
    set textBlockPreprocess(fn) { if ('function'===typeof fn) { this._preprocessor.text=fn } }
    ...
    #getBlocks(text, fences) {
        ...
        blocks.push(this.#makeTextBlock(this._preprocessor.text(text.slice(start)), start, text.length))
